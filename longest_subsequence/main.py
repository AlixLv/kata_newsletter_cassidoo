...
def longest_subsequence(list):
    ...
    if len_list_subsequences == 0:
        ...
        return longest_sub
        # for sub in range(len_list_subsequences - 1):
        #     current_len_sub = len(list_subsequences[sub])
        #     print("🥕 ", list_subsequences[sub], "len: ", current_len_sub)
            
            
        #     compared_list = list_subsequences[sub + 1]
        #     compared_len_sub = len(compared_list)
        #     print("🥒 ", compared_list, "len: ", compared_len_sub)
